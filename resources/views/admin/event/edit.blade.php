                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form target="{{ route('admin.event.update', ['event' => $event->id]) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="startdate" name="start"
                                            value="{{ old('start', $event->start->format('m/d/Y')) }}" required />
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label"
                                                    for="logo">{{ $event->image ? $event->image->url : 'Select Image' }}</label>
                                            </div>
